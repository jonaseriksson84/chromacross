...
function generatePuzzle(date: string): DebugPuzzle {
		...
		if (validateUniqueness(intersection, WORD_LIST)) {
			...
			return {
				...
				debug: {
					...
					isMiddleIntersection:
						intersection.word1_pos >= 1 &&
						intersection.word1_pos <= 3 &&
						intersection.word2_pos >= 1 &&
						intersection.word2_pos <= 3,
				},
			};
		}
	}
